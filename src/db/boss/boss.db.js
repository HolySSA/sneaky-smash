...
export const findBossById = async (id) => {
  ...
  return rows.rows; // 단일 보스 반환 (toCamelCase로 변환된 데이터)
};
...
export const findAllBosses = async () => {
  ...
  return rows.rows; // 모든 보스 반환 (toCamelCase로 변환된 데이터)
};
